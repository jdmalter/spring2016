...
public class DecompositionTest {
	...
	public void testLu() {
		...
		expectedL = new double[][] { new double[] { 1, 0 }, new double[] { -2, 1 } };
		expectedU = new double[][] { new double[] { 2, -1 }, new double[] { 0, -3 } };
		...
		a = new double[][] { new double[] { 2, 4, -1 }, new double[] { -6, -15, 5 }, new double[] { 8, 22, -10 } };
		expectedL = new double[][] { new double[] { 1, 0, 0 }, new double[] { -3, 1, 0, }, new double[] { 4, -2, 1 } };
		expectedU = new double[][] { new double[] { 2, 4, -1 }, new double[] { 0, -3, 2 }, new double[] { 0, 0, -2 } };
		actualLU = Decomposition.lu(a);
		actualL = actualLU[0];
		actualU = actualLU[1];
		...
		a = new double[][] { new double[] { 2, -1, 2, -4 }, new double[] { 4, -5, 5, -12 },
				new double[] { 2, 8, -5, 5 }, new double[] { -8, 16, 4, 40 } };
		expectedL = new double[][] { new double[] { 1, 0, 0, 0 }, new double[] { 2, 1, 0, 0 },
				new double[] { 1, -3, 1, 0 }, new double[] { -4, -4, -4, 1 } };
		expectedU = new double[][] { new double[] { 2, -1, 2, -4 }, new double[] { 0, -3, 1, -4 },
				new double[] { 0, 0, -4, -3 }, new double[] { 0, 0, 0, -4 } };
		actualLU = Decomposition.lu(a);
		actualL = actualLU[0];
		actualU = actualLU[1];
		...
		try {
			...
			testLU = Decomposition
					.lu(new double[][] { new double[] { 0, 0 }, new double[] { 0, 0 }, new double[] { 0, 0 } });
			fail();
		} catch (IllegalArgumentException ex) {
			assertNull(testLU);
		}
	...
	public void testCholesky() {
		...
		expectedL = new double[][] { new double[] { 4, 0 }, new double[] { 2, 4 } };
		...
		// second test on 3 by 3 array
		a = new double[][] { new double[] { 4, 4, -6 }, new double[] { 4, 20, 10 }, new double[] { -6, 10, 29 } };
		expectedL = new double[][] { new double[] { 2, 0, 0 }, new double[] { 2, 4, 0 }, new double[] { -3, 4, 2 } };
		actualL = Decomposition.cholesky(a);
		...
		// third test on 4 by 4 array
		a = new double[][] { new double[] { 4, 8, -6, 6 }, new double[] { 8, 17, -14, 14 },
				new double[] { -6, -14, 17, -5 }, new double[] { 6, 14, -5, 38 } };
		expectedL = new double[][] { new double[] { 2, 0, 0, 0 }, new double[] { 4, 1, 0, 0 },
				new double[] { -3, -2, 2, 0 }, new double[] { 3, 2, 4, 3 } };
		actualL = Decomposition.cholesky(a);
		...
		try {
			// matrix a must does not have as many columns as rows
			testL = Decomposition
					.cholesky(new double[][] { new double[] { 0, 0 }, new double[] { 0, 0 }, new double[] { 0, 0 } });
			fail();
		} catch (IllegalArgumentException ex) {
			assertNull(testL);
		}
		...
		try {
			...
			testL = Decomposition.cholesky(new double[][] { new double[] { 1, 2 }, new double[] { 3, 4 } });
			fail();
		} catch (IllegalArgumentException ex) {
			assertNull(testL);
		}
	...
	public void testQr() {
		...
		// first test on 2 by 2 array
		a = new double[][] { new double[] { 14, -6 }, new double[] { 14, -9 }, new double[] { 7, -6 } };
		expectedQ = new double[][] { new double[] { 2d / 3, 2d / 3 }, new double[] { 2d / 3, -1d / 3 },
				new double[] { 1d / 3, -2d / 3 } };
		expectedR = new double[][] { new double[] { 21, -12 }, new double[] { 0, 3 } };
		...
		a = new double[][] { new double[] { -3, -8, -9 }, new double[] { -3, -10, 15 }, new double[] { -3, -8, 7 },
				new double[] { -3, -10, -1 } };
		expectedQ = new double[][] { new double[] { -0.5, 0.5, -0.5 }, new double[] { -0.5, -0.5, 0.5 },
				new double[] { -0.5, 0.5, 0.5 }, new double[] { -0.5, -0.5, -0.5 } };
		expectedR = new double[][] { new double[] { 6, 18, -6 }, new double[] { 0, 2, -8 }, new double[] { 0, 0, 16 } };
		actualQR = Decomposition.qr(a);
		actualQ = actualQR[0];
		actualR = actualQR[1];
		...
		try {
			...
			testQR = Decomposition.qr(new double[][] { new double[] { 0, 0, 0 }, new double[] { 0, 0, 0 } });
			fail();
		} catch (IllegalArgumentException ex) {
			assertNull(testQR);
		}
		...
		try {
			...
			testQR = Decomposition.qr(new double[][] { new double[] { 0, 0 }, new double[] { 0 } });
			fail();
		} catch (IllegalArgumentException ex) {
			assertNull(testQR);
		}
	...
	public void testEigen() {
		...
		expectedL = new double[][] { new double[] { 3, 0 }, new double[] { 0, 2 } };
		expectedV = new double[][] { new double[] { 3 / Math.sqrt(13d), 2 / Math.sqrt(5d) },
		...
		expectedL = new double[][] { new double[] { 2, 0 }, new double[] { 0, -1 } };
		expectedV = new double[][] { new double[] { -1 / Math.sqrt(5), -2 / Math.sqrt(5) },
		...
		a = new double[][] { new double[] { 2, 3, -3 }, new double[] { -2, -1, 2 }, new double[] { 2, 4, -3 } };
		expectedL = new double[][] { new double[] { 1, 0, 0 }, new double[] { 0, -1, 0 }, new double[] { 0, 0, -2 } };
		expectedV = new double[][] { new double[] { 0, 1 / Math.sqrt(2), 9 / Math.sqrt(185) },
				new double[] { 1 / Math.sqrt(2), 0, -2 / Math.sqrt(185) },
				new double[] { 1 / Math.sqrt(2), 1 / Math.sqrt(2), 10 / Math.sqrt(185) } };
		actualEigen = Decomposition.eigen(a);
		actualL = actualEigen[0];
		actualV = actualEigen[1];
		...
		a = new double[][] { new double[] { 3, 2, 2 }, new double[] { -1, -4, 2 }, new double[] { -2, -2, -1 } };
		expectedL = new double[][] { new double[] { 1, 0, 0 }, new double[] { 0, -1, 0 }, new double[] { 0, 0, -2 } };
		expectedV = new double[][] { new double[] { -7 / Math.sqrt(74), -1 / Math.sqrt(3), -2 / Math.sqrt(17) },
				new double[] { 3 / Math.sqrt(74), 1 / Math.sqrt(3), 3 / Math.sqrt(17) },
				new double[] { 4 / Math.sqrt(74), 1 / Math.sqrt(3), 2 / Math.sqrt(17) } };
		actualEigen = Decomposition.eigen(a);
		actualL = actualEigen[0];
		actualV = actualEigen[1];
		...
		try {
			// matrix a must does not have as many columns as rows
			testEigen = Decomposition
					.eigen(new double[][] { new double[] { 0, 0 }, new double[] { 0, 0 }, new double[] { 0, 0 } });
			fail();
		} catch (IllegalArgumentException ex) {
			assertNull(testEigen);
		}
		...
		try {
			...
			testEigen = Decomposition.eigen(new double[][] { new double[] { 0, 0, 0, 0 }, new double[] { 0, 0, 0, 0 },
	...
	public void testSingularValue() {
		...
		expectedU = new double[][] { new double[] { 1, 0 }, new double[] { 0, -1 } };
		expectedS = new double[][] { new double[] { 10, 0 }, new double[] { 0, 5 } };
		expectedV = new double[][] { new double[] { 0.8, -0.6 }, new double[] { 0.6, 0.8 } };
		...
		actualA = Matrices.multiply(Matrices.multiply(actualU, actualS), Matrices.transpose(actualV));
		assertEquals(a.length, actualA.length);
		...
		a = new double[][] { new double[] { 18, 26 }, new double[] { 18, 1 }, new double[] { -27, -14 } };
		expectedU = new double[][] { new double[] { 2d / 3, 2d / 3 }, new double[] { 1d / 3, -2d / 3 },
				new double[] { -2d / 3, 1d / 3 } };
		expectedS = new double[][] { new double[] { 45, 0 }, new double[] { 0, 15 } };
		expectedV = new double[][] { new double[] { 0.8, -0.6 }, new double[] { 0.6, 0.8 } };
		actualSingular = Decomposition.singularValue(a);
		actualU = actualSingular[0];
		actualS = actualSingular[1];
		...
		a = new double[][] { new double[] { 6, 6, 3 }, new double[] { -1, 2, -2 }, new double[] { 4, -2, -4 } };
		expectedU = new double[][] { new double[] { 1, 0, 0 }, new double[] { 0, 0, -1 }, new double[] { 0, -1, 0 } };
		expectedS = new double[][] { new double[] { 9, 0, 0 }, new double[] { 0, 6, 0 }, new double[] { 0, 0, 3 } };
		expectedV = new double[][] { new double[] { 2d / 3, -2d / 3, 1d / 3 }, new double[] { 2d / 3, 1d / 3, -2d / 3 },
		...
		a = new double[][] { new double[] { 18, 1 }, new double[] { 18, 1 }, new double[] { 6, 17 },
				new double[] { -6, -17 } };
		expectedU = new double[][] { new double[] { 0.5, -0.5 }, new double[] { 0.5, -0.5 }, new double[] { 0.5, 0.5 },
				new double[] { -0.5, -0.5 } };
		expectedS = new double[][] { new double[] { 30, 0 }, new double[] { 0, 20 } };
		expectedV = new double[][] { new double[] { 0.8, -0.6 }, new double[] { 0.6, 0.8 } };
		actualSingular = Decomposition.singularValue(a);
		actualU = actualSingular[0];
		actualS = actualSingular[1];
		...
		a = new double[][] { new double[] { 11, 8, 2 }, new double[] { 13, 4, -2 }, new double[] { 3, 12, -6 },
				new double[] { -5, -8, 10 } };
		expectedU = new double[][] { new double[] { -0.5, 0.5, 0.5 }, new double[] { -0.5, 0.5, -0.5 },
				new double[] { -0.5, -0.5, 0.5 }, new double[] { 0.5, 0.5, 0.5 } };
		expectedS = new double[][] { new double[] { 24, 0, 0 }, new double[] { 0, 12, 0 }, new double[] { 0, 0, 6 } };
		expectedV = new double[][] { new double[] { -2d / 3, 2d / 3, -1d / 3 },
				new double[] { -2d / 3, -1d / 3, 2d / 3 }, new double[] { 1d / 3, 2d / 3, 2d / 3 } };
		actualSingular = Decomposition.singularValue(a);
		actualU = actualSingular[0];
		actualS = actualSingular[1];
		actualV = actualSingular[2];
		...
		try {
			...
			testSingular = Decomposition
					.singularValue(new double[][] { new double[] { 0, 0, 0 }, new double[] { 0, 0, 0 } });
			fail();
		} catch (IllegalArgumentException ex) {
			assertNull(testSingular);
		}
		...
		try {
			// matrix a row width does not remain constant
			testSingular = Decomposition.singularValue(new double[][] { new double[] { 0, 0 }, new double[] { 0 } });
			fail();
		} catch (IllegalArgumentException ex) {
			assertNull(testSingular);
		}
