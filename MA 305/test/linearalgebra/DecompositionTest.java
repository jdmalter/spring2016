...
public class DecompositionTest {
   ...
   public void testLu() {
      ...
      a = new double[][] { new double[] { 2, 4, -1 }, new double[] { -6, -15, 5 },
         new double[] { 8, 22, -10 } };
      expectedL = new double[][] { new double[] { 1, 0, 0 }, new double[] { -3, 1, 0, },
         new double[] { 4, -2, 1 } };
      expectedU = new double[][] { new double[] { 2, 4, -1 }, new double[] { 0, -3, 2 },
         new double[] { 0, 0, -2 } };
      actualLU = Decomposition.lu(a);
      actualL = actualLU[0];
      actualU = actualLU[1];
   ...
   public void testCholesky() {
      ...
      // second test on 3 by 3 array
      a = new double[][] { new double[] { 4, 4, -6 }, new double[] { 4, 20, 10 },
         new double[] { -6, 10, 29 } };
      expectedL = new double[][] { new double[] { 2, 0, 0 }, new double[] { 2, 4, 0 },
         new double[] { -3, 4, 2 } };
      actualL = Decomposition.cholesky(a);
      ...
      try {
         ...
         testL =
            Decomposition.cholesky(new double[][] { new double[] { 1, 2 }, new double[] { 3, 4 } });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testL);
      }
   ...
   public void testQr() {
      ...
      expectedQ = new double[][] { new double[] { 2d / 3, 2d / 3 },
         new double[] { 2d / 3, -1d / 3 }, new double[] { 1d / 3, -2d / 3 } };
      ...
      a = new double[][] { new double[] { -3, -8, -9 }, new double[] { -3, -10, 15 },
         new double[] { -3, -8, 7 }, new double[] { -3, -10, -1 } };
      expectedQ =
         new double[][] { new double[] { -0.5, 0.5, -0.5 }, new double[] { -0.5, -0.5, 0.5 },
            new double[] { -0.5, 0.5, 0.5 }, new double[] { -0.5, -0.5, -0.5 } };
      expectedR = new double[][] { new double[] { 6, 18, -6 }, new double[] { 0, 2, -8 },
         new double[] { 0, 0, 16 } };
      actualQR = Decomposition.qr(a);
      actualQ = actualQR[0];
      actualR = actualQR[1];
      ...
      try {
         ...
         testQR =
            Decomposition.qr(new double[][] { new double[] { 0, 0, 0 }, new double[] { 0, 0, 0 } });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testQR);
      }
   ...
   public void testEigen() {
      ...
      a = new double[][] { new double[] { 2, 3, -3 }, new double[] { -2, -1, 2 },
         new double[] { 2, 4, -3 } };
      expectedL = new double[][] { new double[] { 1, 0, 0 }, new double[] { 0, -1, 0 },
         new double[] { 0, 0, -2 } };
      ...
      a = new double[][] { new double[] { 3, 2, 2 }, new double[] { -1, -4, 2 },
         new double[] { -2, -2, -1 } };
      expectedL = new double[][] { new double[] { 1, 0, 0 }, new double[] { 0, -1, 0 },
         new double[] { 0, 0, -2 } };
      expectedV = new double[][] {
         new double[] { -7 / Math.sqrt(74), -1 / Math.sqrt(3), -2 / Math.sqrt(17) },
      ...
      try {
         ...
         testEigen = Decomposition
            .eigen(new double[][] { new double[] { 0, 0, 0, 0 }, new double[] { 0, 0, 0, 0 },
   ...
   public void testSingularValue() {
      ...
      for (int row = 0; row < actualS.length; row++)
         for (int col = 0; col < actualS[row].length; col++)
            if (row == col) assertNotEquals(0, actualS[row][col], DELTA);

            else assertEquals(0, actualS[row][col], DELTA);

      // second test on 2 by 3 array
      a = new double[][] { new double[] { 18, 26 }, new double[] { 18, 1 },
         new double[] { -27, -14 } };
      expectedU = new double[][] { new double[] { 2d / 3, 2d / 3 },
         new double[] { 1d / 3, -2d / 3 }, new double[] { -2d / 3, 1d / 3 } };
      ...
      a = new double[][] { new double[] { 6, 6, 3 }, new double[] { -1, 2, -2 },
         new double[] { 4, -2, -4 } };
      expectedU = new double[][] { new double[] { 1, 0, 0 }, new double[] { 0, 0, -1 },
         new double[] { 0, -1, 0 } };
      expectedS = new double[][] { new double[] { 9, 0, 0 }, new double[] { 0, 6, 0 },
         new double[] { 0, 0, 3 } };
      ...
      a = new double[][] { new double[] { 18, 1 }, new double[] { 18, 1 }, new double[] { 6, 17 },
         new double[] { -6, -17 } };
      expectedU = new double[][] { new double[] { 0.5, -0.5 }, new double[] { 0.5, -0.5 },
      ...
      a = new double[][] { new double[] { 11, 8, 2 }, new double[] { 13, 4, -2 },
         new double[] { 3, 12, -6 }, new double[] { -5, -8, 10 } };
      expectedU =
         new double[][] { new double[] { -0.5, 0.5, 0.5 }, new double[] { -0.5, 0.5, -0.5 },
            new double[] { -0.5, -0.5, 0.5 }, new double[] { 0.5, 0.5, 0.5 } };
      expectedS = new double[][] { new double[] { 24, 0, 0 }, new double[] { 0, 12, 0 },
         new double[] { 0, 0, 6 } };
      expectedV = new double[][] { new double[] { -2d / 3, 2d / 3, -1d / 3 },
         new double[] { -2d / 3, -1d / 3, 2d / 3 }, new double[] { 1d / 3, 2d / 3, 2d / 3 } };
      actualSingular = Decomposition.singularValue(a);
      ...
      try {
         // matrix a row width does not remain constant
         testSingular = Decomposition
            .singularValue(new double[][] { new double[] { 0, 0 }, new double[] { 0 } });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testSingular);
      }
