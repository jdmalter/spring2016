...
public class ContrainedTest {
   ...
   public void testOverconstrainedPI() {
      ...
      expectedE =
         new double[][] { new double[] { 0.839 }, new double[] { 2.875 }, new double[] { 0.120 } };
      ...
      a = new double[][] { new double[] { -3, 4, 3 }, new double[] { -3, -2, -4 },
         new double[] { 4, 2, -1 }, new double[] { 3, 1, -3 } };
      b = new double[][] { new double[] { 2 }, new double[] { -3 }, new double[] { 1 },
         new double[] { 1 } };
      expectedX =
         new double[][] { new double[] { 0.239 }, new double[] { 0.473 }, new double[] { 0.266 } };
      expectedE = new double[][] { new double[] { -0.030 }, new double[] { 0.273 },
         new double[] { 0.637 }, new double[] { -0.607 } };
      actualXE = Constrained.overconstrainedPI(a, b);
      actualX = actualXE[0];
      actualE = actualXE[1];
      ...
      a = new double[][] { new double[] { 3, -1, -1 }, new double[] { -3, 2, -3 },
         new double[] { 2, -4, -2 }, new double[] { -4, -3, -1 }, new double[] { 3, 1, -1 } };
      b = new double[][] { new double[] { 3 }, new double[] { 3 }, new double[] { 1 },
         new double[] { 1 }, new double[] { 4 } };
      expectedX =
         new double[][] { new double[] { 0.307 }, new double[] { 0.232 }, new double[] { -1.318 } };
      expectedE = new double[][] { new double[] { -0.994 }, new double[] { 0.497 },
         new double[] { 1.319 }, new double[] { -1.606 }, new double[] { -1.530 } };
      actualXE = Constrained.overconstrainedPI(a, b);
      actualX = actualXE[0];
      actualE = actualXE[1];
      ...
      try {
         ...
         testXE =
            Constrained.overconstrainedPI(new double[][] { new double[] {} }, new double[][] {});
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testXE);
      }
      ...
      try {
         ...
         testXE = Constrained.overconstrainedPI(new double[][] { new double[] {} },
            new double[][] { null });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testXE);
   ...
   public void testUnderconstrainedPI() {
      ...
      expectedX =
         new double[][] { new double[] { 0.206 }, new double[] { 0.454 }, new double[] { 0.463 } };
      ...
      expectedX = new double[][] { new double[] { 0.279 }, new double[] { -0.555 },
         new double[] { -0.277 }, new double[] { -0.058 } };
      actualX = Constrained.underconstrainedPI(a, b);
      ...
      try {
         // matrix a and b do not have equal number of rows
         testX =
            Constrained.underconstrainedPI(new double[][] { new double[] {} }, new double[][] {});
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testX);
      }
      ...
      try {
         // matrix b does contain null column
         testX = Constrained.underconstrainedPI(new double[][] { new double[] {} },
            new double[][] { null });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testX);
   ...
   public void testOverconstrainedCD() {
      ...
      try {
         // matrix a and b do not have equal number of rows
         testXE =
            Constrained.overconstrainedCD(new double[][] { new double[] {} }, new double[][] {});
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testXE);
      }
      ...
      try {
         // matrix b does contain null column
         testXE = Constrained.overconstrainedCD(new double[][] { new double[] {} },
            new double[][] { null });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testXE);
   ...
   public void testOverconstrainedQR() {
      ...
      try {
         // matrix a and b do not have equal number of rows
         testXE =
            Constrained.overconstrainedQR(new double[][] { new double[] {} }, new double[][] {});
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testXE);
      }
      ...
      try {
         // matrix b does contain null column
         testXE = Constrained.overconstrainedQR(new double[][] { new double[] {} },
            new double[][] { null });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testXE);
   ...
   public void testOverconstrainedSV() {
      ...
      try {
         // matrix a and b do not have equal number of rows
         testXE =
            Constrained.overconstrainedSV(new double[][] { new double[] {} }, new double[][] {});
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testXE);
      }
      ...
      try {
         // matrix b does contain null column
         testXE = Constrained.overconstrainedSV(new double[][] { new double[] {} },
            new double[][] { null });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testXE);
   ...
   public void testUnderconstrainedSV() {
      ...
      try {
         // matrix a and b do not have equal number of rows
         testX =
            Constrained.underconstrainedSV(new double[][] { new double[] {} }, new double[][] {});
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testX);
      }
      ...
      try {
         // matrix b does contain null column
         testX = Constrained.underconstrainedSV(new double[][] { new double[] {} },
            new double[][] { null });
         fail();
      } catch (IllegalArgumentException ex) {
         assertNull(testX);
